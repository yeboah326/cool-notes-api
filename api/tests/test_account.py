...
def test_account_create_successful(client):
    ...
    response = client.post(
        "/api/account/",
        json={"name": "John Doe", "email": "jdoe@gmail.com", "password": "123456789", "account_type":"normal"},
    )
...
def test_account_create_error(client):
    ...
    assert response.json["errors"] == {'account_type': ['Missing data for required field.']}
...
def test_account_authenticate_successful(client):
    ...
    response = client.post("/api/account/auth", json={"email": "jdoe@gmail.com", "password": "123456789"})
...
def test_account_authenticate_wrong_credentials(client):
    ...
    response = client.post("/api/account/auth", json={"email": "jdoe@gmail.com", "password": "1234567890"})
